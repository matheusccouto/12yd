...
# the 7 x 6 = 42 in-scope club (league, season) pairs (Copa Libertadores,
...
CLUB_LEAGUE_SEASONS: dict[int, tuple[int, ...]] = dict.fromkeys(
    sorted(CLUB_LEAGUE_IDS), (2021, 2022, 2023, 2024, 2025, 2026),
)
