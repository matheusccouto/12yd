...
5. If the issue has acceptance criteria in docs/PRD-v5.md, mark them done if applicable.
...
The following files are loaded into your context: docs/PRD-v5.md is the PRD that drives the work, progress.txt is the structured log of completed work, AGENTS.md is the agent-facing config, and CONTEXT.md is the domain glossary.
'
